...
#define     ADVTIM_TIM_CHANNEL3PULSE         0//(ADVICE_TIM_PERIOD+1)/4//0//0x71
...
extern	void	ADVTIM_Reset(ADVTIM_TypeDef* TIMx);
extern	void	ADVTIM_ReleaseReset(ADVTIM_TypeDef* TIMx);
